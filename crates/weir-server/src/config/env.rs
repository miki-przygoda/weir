...
pub(super) fn read() -> Result<PartialConfig, ConfigError> {
    Ok(PartialConfig {
        ...
        wab_segment_max_lifetime_secs: env_parse("WEIR_WAB_SEGMENT_MAX_LIFETIME_SECS")?,
        ...
        sink_s3_bucket: env_string("WEIR_SINK_S3_BUCKET")?,
        sink_s3_region: env_string("WEIR_SINK_S3_REGION")?,
        sink_s3_endpoint: env_string("WEIR_SINK_S3_ENDPOINT")?,
        sink_s3_prefix: env_string("WEIR_SINK_S3_PREFIX")?,
        sink_s3_partition: env_string("WEIR_SINK_S3_PARTITION")?,
        sink_s3_framing: env_string("WEIR_SINK_S3_FRAMING")?,
        sink_s3_compression: env_string("WEIR_SINK_S3_COMPRESSION")?,
        sink_s3_access_key_id: env_string("WEIR_SINK_S3_ACCESS_KEY_ID")?,
        sink_s3_secret_access_key: env_string("WEIR_SINK_S3_SECRET_ACCESS_KEY")?,
        sink_s3_storage_class: env_string("WEIR_SINK_S3_STORAGE_CLASS")?,
        sink_s3_sse: env_string("WEIR_SINK_S3_SSE")?,
        sink_s3_sse_kms_key_id: env_string("WEIR_SINK_S3_SSE_KMS_KEY_ID")?,
        sink_s3_force_path_style: env_bool("WEIR_SINK_S3_FORCE_PATH_STYLE")?,
